...
const YEARS = ['2024', '2023', '2019', '2018']; // Start with most recent
...
async function importYearData(year) {
  ...
  try {
    ...
    if (error) {
      console.error(`Error upserting ${year} data:`, error);
    } else {
...
async function main() {
  ...
  console.log('Using batch upsert operations for speed');
