...
export const metadata = {
  ...
  description: "Discover the best schools in Manchester with detailed Ofsted ratings, performance data, and catchment areas. Free school finder for Manchester schools. 200+ monthly searches.",
  keywords: "schools in manchester, manchester schools, best schools manchester, primary schools manchester, secondary schools manchester, manchester school finder, schools near me manchester",
  openGraph: {
    title: "Schools in Manchester - Find the Best Schools in Manchester | SchoolChecker.io",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="h-[600px] md:h-[700px]">
              <ClientSchoolsMap city="manchester" />
            </div>
          </div>
        </div>
      </div>
