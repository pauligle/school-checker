...
export const metadata = {
  ...
  description: "Discover the best schools in Liverpool with detailed Ofsted ratings, performance data, and catchment areas. Free school finder for Liverpool schools. 60+ monthly searches.",
  keywords: "schools in liverpool, liverpool schools, best schools liverpool, primary schools liverpool, secondary schools liverpool, liverpool school finder, schools near me liverpool",
  openGraph: {
    title: "Schools in Liverpool - Find the Best Schools in Liverpool | SchoolChecker.io",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="h-[600px] md:h-[700px]">
              <ClientSchoolsMap city="liverpool" />
            </div>
          </div>
        </div>
      </div>
