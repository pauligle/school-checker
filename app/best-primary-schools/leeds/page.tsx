...
import LeedsSchoolsMap from '@/components/LeedsSchoolsMap'
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-6xl">
            <div className="flex items-center justify-between mb-4 md:mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Primary Schools in Leeds Area</h2>
              <div className="text-sm text-gray-600">
                Showing {schools.length} schools in LS postcode area
              </div>
            </div>
            <LeedsSchoolsMap schools={schools} />
          </div>
        </div>
      </div>
